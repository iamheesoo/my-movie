...
data class MovieResponse(
    ...
    val originCountryList: List<String> = emptyList(),
    ...
    val productionCompanyList: List<ProductionCompanyData> = emptyList(),
    @SerialName("production_countries")
    val productionCountryList: List<ProductionCountryData> = emptyList(),
    ...
    val spokenLanguageList: List<SpokenLanguageData> = emptyList(),
    @SerialName("status")
    val status: String = "",
    @SerialName("tagline")
    val tagline: String = "",
